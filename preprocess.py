...
#    date = sys.argv[1]
    for group_id in group_ids:
        read_path = date+'/g-'+group_id+'.csv'
        write_path = date+'/g-'+group_id+'-c.csv'
        #讀檔，注意encoding
        print("Reading from", group_id+"...")
    ...
    #        print(sentence)
        ...
        #存檔
        print("Writing to %s" % write_path,end="... ")    
        df['message'] = d    
        df.to_csv(write_path,index_label='index',columns=['id','message'],encoding='utf-8')
        print("done.")
